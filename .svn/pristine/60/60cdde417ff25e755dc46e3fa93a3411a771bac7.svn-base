...
static ast parseStatement()
{
    ...
    switch (token_kind()) {
        ...
        case tk_lcb:
            ...
            break;
        case tk_do:
            stat=parseDoStatement();
            break;
        case tk_throw:
            stat=parseThrowStatement();
            break;
        case tk_switch:
             stat=parseSwitchStatement();
             break;
        default:
...
static ast parseSwitchStatement()
{
    ...
    mustbe(tk_rrb);
    mustbe(tk_lcb);
    stats.push_back( parseLabelled());
    while (have(tg_starts_labelled)){
          stats.push_back( parseLabelled());
    }
